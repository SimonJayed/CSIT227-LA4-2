        ...
        for (Person person : persons) {
            if (person.getName().equals(name)) {
                if (!type.isInstance(person)) {
                    if(type.getSimpleName().toLowerCase().equals("employee")){
                        throw new ClassCastException(name + " is not an " + type.getSimpleName().toLowerCase());
                    }
                    throw new ClassCastException(name + " is not a " + type.getSimpleName().toLowerCase());
                }
